...
xres = load_xresources('qutebrowser.color')
...
config.bind('wp', 'spawn --userscript workmode_private')  # default private tab key
config.bind('<Ctrl-Shift-n>', 'spawn --userscript workmode_private')
...
## list) will work.
## Type: List of String
c.qt.args = ['disable-background-timer-throttling=false']
...
c.url.searchengines = {
        ...
        '!ai': 'https://www.perplexity.ai/?q={}',
        '!book': 'https://annas-archive.li/search?q={}',
        '!gl': 'https://www.google.com/search?q={}',
        '!torrent': 'https://www.1337x.to/search/{}/1/',
